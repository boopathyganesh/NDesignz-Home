  ...
  return (
    <main className="max-w-7xl mx-auto w-full flex flex-col items-center justify-center">
      ...
      <section className="flex flex-col items-center justify-center gap-5 mb-10">
        ...
        <ul className="list-decimal list-inside flex flex-col items-center justify-center gap-5 text-lg">
          <li>
