...
const MiniCard = ({title,icon,content}:CardProps) => {
    return (
        <div className='w-44 h-48 group hover:bg-white hover:scale-105 hover:-rotate-12 text-black flex flex-col items-center justify-center rounded-xl p-2 gap-2 smooth border border-teal'>
